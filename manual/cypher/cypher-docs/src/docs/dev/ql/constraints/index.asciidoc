...
* <<query-constraints-unique-nodes,Unique node property constraints>>
* <<query-constraints-prop-exist-nodes,Node property existence constraints>>
* <<query-constraints-prop-exist-rels,Relationship property existence constraints>>
