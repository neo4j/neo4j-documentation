...
https://github.com/neo4j/neo4j-documentation/blob/{neo4j-git-tag}/manual/cypher/cypher-docs/src/test/java/org/neo4j/cypher/example/JavaQuery.java[JavaQuery.java]
--

In Java, you can use the link:{cypher-query-lang-uri}[Cypher query language] as per the example below.
...
For more information and examples for Cypher, see link:{cypher-query-lang-uri}[Developer Manual -> Cypher].
