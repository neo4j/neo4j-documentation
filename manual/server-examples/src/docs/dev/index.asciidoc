...
Both require the user to be familiar with the Java programming language and to have an environment set up for compiling Java code.
...
include::procedures-extensions-desktop.asciidoc[]
