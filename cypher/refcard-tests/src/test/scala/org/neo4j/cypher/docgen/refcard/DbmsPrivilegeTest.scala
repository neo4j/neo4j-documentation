...
Grant privilege to perform all role, user, database, privilege, procedure, function and impersonation management to a role.

###assertion=update-one
//

DENY IMPERSONATE (alice) TO my_role
###
