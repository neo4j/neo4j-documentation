...
//cypher/cypher-docs/src/docs/graphgists/query-tuning/movies.csv
//cypher/cypher-docs/src/docs/graphgists/query-tuning/actors.csv
//cypher/cypher-docs/src/docs/graphgists/query-tuning/directors.csv
...
The <<query-plan-filter,Filter>> operator which will check the `name` property on each of the nodes passed through by `AllNodesScan`.
