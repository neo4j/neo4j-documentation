...
[%header, cols="2h,1,1,1,1,1,1,1,1"]
|===
|
8+^|Node
1.1+|`LABEL` expression | `()` | `(:A)` | `(:B)` | `(:C)` | `(:A:B)` | `(:A:C)` | `(:B:C)` | `(:A:B:C)`
1.1+| () | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:A) | | {check-mark} | | | {check-mark} | {check-mark} | | {check-mark}
1.1+| (:A&B) | | | | | {check-mark} | | | {check-mark}
1.1+| (:A\|B) | | {check-mark} | {check-mark} | | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:!A) | {check-mark} | | {check-mark} | {check-mark} | | | {check-mark} |
1.1+| (:!!A) | | {check-mark} | | | {check-mark} | {check-mark} | | {check-mark}
1.1+| (:A&!A) | | | | | | | |
1.1+| (:A\|!A) | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:%) | | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:!%) | {check-mark} | | | | | | |
1.1+| (:%\|!%) | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:%&!%) | | | | | | | |
1.1+| (:A&%) | | {check-mark} | | | {check-mark} | {check-mark} | | {check-mark}
1.1+| (:A\|%) | | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark} | {check-mark}
1.1+| (:(A&B)&!(B&C)) | | | | | {check-mark} | | |
1.1+| (:!(A&%)&%)) | | | {check-mark} | {check-mark} | | | {check-mark} |
|===
