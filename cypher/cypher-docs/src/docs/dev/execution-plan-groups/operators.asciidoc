...
include::../ql/query-plan/drop-unique-constraint-deprecated.asciidoc[]

include::../ql/query-plan/create-node-property-existence-constraint.asciidoc[]

include::../ql/query-plan/drop-node-property-existence-constraint-deprecated.asciidoc[]

include::../ql/query-plan/create-node-key-constraint.asciidoc[]

include::../ql/query-plan/drop-node-key-constraint-deprecated.asciidoc[]

include::../ql/query-plan/create-relationship-property-existence-constraint.asciidoc[]

include::../ql/query-plan/drop-relationship-property-existence-constraint-deprecated.asciidoc[]

include::../ql/query-plan/drop-named-constraint.asciidoc[]

include::../ql/query-plan/create-index.asciidoc[]

include::../ql/query-plan/drop-index-deprecated-syntax.asciidoc[]

include::../ql/query-plan/drop-index-new-syntax.asciidoc[]
