...
| <<query-plan-listing-constraints, ShowConstraints>>      | Lists the available constraints. | Y | |
| <<query-plan-listing-functions, ShowFunctions>>              | Lists the available functions. | Y | |
| <<query-plan-listing-indexes, ShowIndexes>>              | Lists the available indexes. | Y | |
| <<query-plan-listing-procedures, ShowProcedures>>              | Lists the available procedures. | Y | |
