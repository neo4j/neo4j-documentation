...
These comprise clauses used to manage databases, schema and security; further details can found in <<databases, Database management>> and <<access-control, Access Control>>.
