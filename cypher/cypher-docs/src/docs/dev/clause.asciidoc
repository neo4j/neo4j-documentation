...
|===
|Clause |Description
m|<<query-listing-transactions, SHOW TRANSACTIONS>>
|Lists the available procedures.
m|<<query-terminate-transactions, TERMINATE TRANSACTIONS>>
...
include::ql/listing/query-listing-transactions.adoc[leveloffset=+1]
