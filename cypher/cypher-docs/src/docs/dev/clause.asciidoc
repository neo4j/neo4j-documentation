...
These comprise clauses used to manage databases, schema and security; for further details see <<administration-databases,Database management>> and <<access-control,Access Control>>.
