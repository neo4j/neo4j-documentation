...
More information about how the statistics are kept up to date, as well as configuration options about managing query replanning can be found in the <<operations-manual#schema-statistics, Operations Manual -> Statistics gathering>>
