...
| <<query-plan-list-constraints, ListConstraints>>                           | List constraints with either verbose of brief output. | Y | |
| <<query-plan-list-indexes, ListIndexes>>                                   | List indexes with either verbose of brief output. | Y | |
