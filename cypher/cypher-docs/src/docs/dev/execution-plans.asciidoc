...
| <<query-plan-lock, LockNodes>>                                                | Locks the start and end node when creating a relationship. | |
...
| <<query-plan-triadic-selection, TriadicSelection>>                                            | Solve triangular queries, such as the very common 'find my friend-of-friends that are not already my friend'. | |
