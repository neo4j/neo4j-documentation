...
include::ql/administration/indexes/node-index-example.asciidoc[leveloffset=2]

include::ql/administration/indexes/relationship-index-example.asciidoc[leveloffset=2]
