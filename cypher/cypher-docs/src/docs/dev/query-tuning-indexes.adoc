...
Node indexes and relationship indexes operate [... on the predicates in the where-clause ...] in the same way.
Therefore, we will use node and relationship indexes interchangeably in this section.
...
include::ql/administration/indexes/a-simple-node-index-example.asciidoc[leveloffset=2]

include::ql/administration/indexes/a-simple-relationship-index-example.asciidoc[leveloffset=2]
