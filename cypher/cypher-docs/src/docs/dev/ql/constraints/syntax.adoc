...
The index type of the backing index is set depending on the provider, the `range-1.0` generates a range index while the other providers generate a b-tree index.
