...
Dropping a constraint requires <<access-control-database-administration-constraints, the `DROP CONSTRAINT` privilege>>.
...
This requires <<access-control-database-administration-constraints, the `SHOW CONSTRAINT` privilege>>.
