...
A database index is a redundant copy of the data in the database for the purpose of making more efficient the retrieval of the aforementioned data.
...
[NOTE]
Use <<query-using, hints>> to force Cypher to use specific indexes.
