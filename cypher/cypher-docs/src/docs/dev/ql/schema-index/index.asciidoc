...
* <<schema-index-use-index-with-where-using-multiple-range-comparisons, Use index with `WHERE` using multiple range comparisons>>
...
* <<schema-index-use-index-when-executing-a-spatial-bounding-box-search, Use index when executing a spatial bounding box search>>
...
include::use-index-with-where-using-multiple-range-comparisons.asciidoc[]
...
include::use-index-when-executing-a-spatial-bounding-box-search.asciidoc[]
