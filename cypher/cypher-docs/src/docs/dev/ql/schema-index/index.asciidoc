...
Cypher allows the creation of indexes over one or more properties for all nodes that have a given label.
...
include::create-an-index-on-a-single-property-and-node-label.asciidoc[]

include::drop-an-index-on-a-single-property-and-node-label.asciidoc[]

include::use-index.asciidoc[]

include::use-index-on-a-single-property-and-node-label-with-where-using-equality.asciidoc[]
