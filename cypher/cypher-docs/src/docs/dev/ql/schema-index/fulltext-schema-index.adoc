...
See the <<operations-manual#index-configuration-fulltext-search, Full-text Schema Indexes>> section of the Operations Manual, for how to configure the default full-text index configurations in <<operations-manual#file-locations, _neo4j.conf_>>.
====
...
The full-text schema indexes uses Lucene under the hood.
