...
* <<call-call-a-procedure, Call a procedure using `CALL`>>
...
* <<call-call-a-procedure-within-a-complex-query, Call a procedure within a complex query using `CALL...YIELD`>>
