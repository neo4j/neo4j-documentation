...
|<<functions-point-cartesian,point() - Cartesian 2D>>            | Returns a 2D point object, given two coordinate values in the Cartesian coordinate system.
|<<functions-point,point() - WGS 84 2D>>            | Returns a 2D point object, given two coordinate values in the WGS 84 coordinate system.
|===
