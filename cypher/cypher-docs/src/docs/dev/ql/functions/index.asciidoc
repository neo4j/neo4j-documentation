...
Values of the <<cypher-temporal, temporal types>> -- Date, Time, LocalTime, DateTime, LocalDateTime and Duration -- can be created manipulated using the following functions:
