...
* When using `+file:///+` URLs, if the file name has spaces or other than alpha numerics, then it needs to be URL encoded ( see https://www.w3schools.com/tags/ref_urlencode.ASP).
