...
* <<load-csv-using-linenumber-function-with-load-csv, Using linenumber() with LOAD CSV>>
* <<load-csv-using-file-function-with-load-csv, Using file() with LOAD CSV>>
...
include::using-linenumber-function-with-load-csv.asciidoc[]

include::using-file-function-with-load-csv.asciidoc[]
