...
There are preparations for introducing two new types of indexes, point and range indexes.
They cannot be used in queries yet, only created and dropped for migration purposes.
