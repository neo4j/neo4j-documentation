...
| <<administration-security-roles-grant, GRANT ROLE[S] ... TO>>                                                                                                                     | Database       | Stops a specified database.
...
| <<administration-databases-show-databases, SHOW DEFAULT DATABASE>>                                                                                                                | User and role  | Assigns one or multiple roles to one or multiple users.
| <<administration-security-subgraph-show, SHOW [ROLE ... \| USER ... \| ALL ] PRIVILEGES>>                                                                                                                 | Database       | Returns information about the default database.
| <<administration-security-users-show, SHOW USERS>>                                                                                         | Privilege      | Returns information about role, user or all privileges.
| <<administration-databases-start-database, START DATABASE>>                                                                                                                       | Database       | Starts up a specified database.
| <<administration-databases-stop-database, STOP DATABASE>>                                                                                                                                | User and role  | Returns information about all users.
|===
...
| <<administration-security-administration-dbms-privileges-database-management, CREATE DATABASE>>         | DBMS                  | Determines whether the user can create new roles.
...
| <<administration-security-administration-dbms-privileges-database-management, DATABASE MANAGEMENT>>     | DBMS                  | Determines whether the user can create and drop databases.
