...
|<<administrationnstraints-syntax, CREATE CONSTRAINT [existence] [IF NOT EXISTS] ON ()-[r:REL_TYPE]-() ASSERT exists(r.property)>>  | Schema   | Create a constraint ensuring that all relationships with a particular type have a certain property.
