...
|<<count-subqueries, COUNT {...}>>  | Reading sub-clause | An expression used to compute the number of results of a subquery inside another clause, e.g. `MATCH`, `WITH`, `SET`, etc.
