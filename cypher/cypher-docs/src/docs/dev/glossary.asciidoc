...
| <<administration-security-roles-alter, ALTER ROLE ... SET NAME ...>>                                                                                                              | User and role  | Changes the name of a role.
| <<administration-security-users-alter, ALTER USER ... [SET [PLAINTEXT \| ENCRYPTED] PASSWORD {... [CHANGE [NOT] REQUIRED] \| CHANGE [NOT] REQUIRED}] [SET STATUS {ACTIVE \| SUSPENDED}] [SET NAME ...]>>             | User and role  | Changes a user account. Changes can include setting a new password, new name, the account status and enabling that the user should change the password upon next login.
...
| <<administration-security-administration-dbms-privileges-user-management, ALTER ROLE>>                  | DBMS                  | Determines whether the user can modify roles.
...
| <<administration-security-administration-dbms-privileges-user-management, SET USER NAME>>               | DBMS                  | Determines whether the user can modify the name of users.
