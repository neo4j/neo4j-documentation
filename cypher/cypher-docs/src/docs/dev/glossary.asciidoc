...
| <<administration-security-administration-dbms-privileges-database-management, SET DATABASE ACCESS>>     | DBMS                  | Determines whether the user can modify the database access mode.
