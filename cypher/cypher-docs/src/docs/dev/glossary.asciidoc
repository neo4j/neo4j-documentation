...
| <<administration-databases-alter-database, ALTER DATABASE ... [IF EXISTS] SET ACCESS {READ ONLY \| READ WRITE}>>                                                                  | Database       | Modifies a database. In this Neo4j version, only the database access can be modified.
...
| <<administration-security-administration-dbms-privileges-database-management, ALTER DATABASE>>          | DBMS                  | Determines whether the user can modify databases.
...
| <<administration-security-administration-dbms-privileges-database-management, DATABASE MANAGEMENT>>     | DBMS                  | Determines whether the user can create, delete and modify databases.
...
| <<administration-security-administration-dbms-privileges-database-management, SET DATABASE ACCESS>>     | DBMS                  | Determines whether the user can modify access of databases.
