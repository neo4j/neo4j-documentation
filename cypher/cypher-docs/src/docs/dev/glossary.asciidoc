...
| <<administration-security-administration-dbms-privileges-role-management, DENY ... ON DBMS TO>>                                                                                   | Privilege      | Denies a DBMS privilege to one or multiple roles.
...
| <<administration-databases-drop-database, DROP DATABASE ... [IF EXISTS]>>                                                                                                         | Database       | Deletes a specified database.
| <<administration-managing-roles-drop, DROP ROLE ... [IF EXISTS]>>                                                                                                                 | User and role  | Deletes a specified role.
| <<administration-managing-users-drop, DROP USER ... [IF EXISTS]>>                                                                                                                 | User and role  | Deletes a specified user.
...
| <<administration-security-administration-dbms-privileges-role-management, GRANT ... ON DBMS TO>>                                                                                  | Privilege      | Assigns a DBMS privilege to one or multiple roles.
...
| <<administration-managing-roles-grant, GRANT ROLE[S] ... TO>>                                                                                                                     | User and role  | Assigns one or multiple roles to one or multiple users.
...
| <<administration-security-administration-dbms-privileges-role-management, REVOKE [GRANT \| DENY] ... ON DBMS FROM>>                                                               | Privilege      | Removes a DBMS privilege from one or multiple roles.
...
| <<administration-managing-roles-revoke, REVOKE ROLE[S] ... FROM>>                                                                                                                 | User and role  | Removes one or multiple roles from one or multiple users.
| <<administration-managing-roles-show, SHOW [ALL \| POPULATED] ROLES [WITH USERS]>>                                                                                                | User and role  | Returns information about all or populated roles, optionally including the assigned users.
...
| <<administration-managing-users-show, SHOW USERS>>                                                                                                                                | User and role  | Returns information about all users.
|===
