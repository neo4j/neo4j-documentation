...
| <<administration-security-administration-database-transaction, TERMINATE TRANSACTION>>        | Database              | Determines whether a user is allowed to kill transactions and queries.
| <<administration-security-administration-database-transaction, TRANSACTION MANAGEMENT>>       | Database              | Determines whether a user is allowed to list and kill transactions and queries.
