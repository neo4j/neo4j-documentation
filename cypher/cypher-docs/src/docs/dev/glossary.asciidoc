...
| <<administration-databases-create-database, CREATE [OR REPLACE] DATABASE ... [IF NOT EXISTS]>>                                                                                    | Database administration       | Creates a new database.
...
| <<administration-security-administration-database-privileges, GRANT ... ON DATABASE ... TO>>                                                                                      | Privilege administration      | Assigns a database, schema, or token privilege to one or multiple roles.
...
| <<administration-security-administration-database-privileges, DENY ... ON DATABASE ... TO>>                                                                                       | Privilege administration      | Denies a database, schema, or token privilege to one or multiple roles.
...
| <<administration-security-administration-database-privileges, REVOKE [GRANT \| DENY] ... ON DATABASE ... FROM>>                                                                   | Privilege administration      | Removes a database, schema, or token privilege from one or multiple roles.
...
| <<administration-security-administration-database-all, ALL DATABASE PRIVILEGES>>              | Database and schema   | Implies all privileges from the categories Database, Schema, and Token for a specific database.
