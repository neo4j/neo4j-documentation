...
|<<administration-indexes-list-indexes, SHOW [ALL\|BTREE\|FULLTEXT\|LOOKUP] INDEX[ES]>> | Schema | List indexes in the database, either all or filtered on b-tree, fulltext or token lookup indexes. Also allows `WHERE` and `YIELD` clauses.
...
| <<administration-database-aliases-alter-alias, ALTER ALIAS ... [IF EXISTS] SET DATABASE TARGET ...>>                                                                              | Database Alias | Modifies the target of a database alias.
...
| <<administration-databases-alter-database, ALTER DATABASE ... [IF EXISTS] SET ACCESS {READ ONLY \| READ WRITE}>>                                                                  | Database       | Modifies the database access mode.
...
| <<administration-database-aliases-create-alias, CREATE [OR REPLACE] ALIAS ... [IF NOT EXISTS] FOR DATABASE ... >>                                                                 | Database Alias | Creates a new database alias.
...
| <<administration-database-aliases-drop-alias, DROP ALIAS ... [IF EXISTS] FOR DATABASE>>                                                                                           | Database Alias | Deletes a specified database alias.
...
| <<administration-security-users-drop, DROP USER ... [IF EXISTS]>>
| User and role  | Deletes a specified user.
...
| <<administration-security-subgraph-show, SHOW [ROLE ... \| USER ... \| ALL ] PRIVILEGES [AS [REVOKE] COMMAND[S]]>>                                                                                         | Privilege      | Returns information about role, user or all privileges.
...
| <<access-control-dbms-administration-database-management, ALTER DATABASE>>          | DBMS                  | Determines whether the user can modify databases.
...
| <<access-control-dbms-administration-database-management, CREATE DATABASE>>         | DBMS                  | Determines whether the user can create new databases.
...
| <<access-control-dbms-administration-database-management, DATABASE MANAGEMENT>>     | DBMS                  | Determines whether the user can create and delete databases.
...
| <<access-control-dbms-administration-database-management, DROP DATABASE>>           | DBMS                  | Determines whether the user can delete databases.
