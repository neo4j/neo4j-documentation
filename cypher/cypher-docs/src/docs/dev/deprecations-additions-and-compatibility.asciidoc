...
----
a|
Rounding infinity and NaN values will newly return the original value instead of
returning an integer approximation for precision 0 (Inf -> 9223372036854776000.0, Nan -> 0) or
throwing an exception for precision > 0.
