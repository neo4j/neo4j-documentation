...
| `CREATE LOOKUP INDEX ...`                     | Functionality | Added         | Create lookup index for nodes with any labels or relationships with any types. They can be dropped by using their name.
