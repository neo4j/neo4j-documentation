...
----
a|
B-tree indexes are deprecated and will need migration before upgrading to 5.0.
...
----
a|
Node key and uniqueness constraints with b-tree options are deprecated and will need migration before upgrading to 5.0.
