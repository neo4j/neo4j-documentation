...
| `SET NAME` | Syntax | Added | For `ALTER USER` it is now possible to alter the name of a user.
| `ALTER ROLE` | Syntax | Added | It is now possible to alter the name of a role.
|===
