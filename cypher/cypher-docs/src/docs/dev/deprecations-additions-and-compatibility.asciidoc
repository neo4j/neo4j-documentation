...
----
a|
New Cypher command for altering an alias to target another database. Remote aliases are only supported from version 4.4.6.
...
----
a|
New Cypher command for listing database aliases.
...
----
a|
New privilege that allows a user to create, modify and delete aliases. Only supported since version 4.4.6.
