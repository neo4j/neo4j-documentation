...
| `RENAME ROLE` | Syntax | Added | New Cypher command for changing the name of a role
| `RENAME USER` | Syntax | Added | New Cypher command for changing the name of a user
|===
