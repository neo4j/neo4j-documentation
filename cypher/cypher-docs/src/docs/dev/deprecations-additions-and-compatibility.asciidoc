...
----
.2+.^a|
B-tree indexes are deprecated and need to be migrated before upgrading to 5.0.
...
B-tree indexes used for spatial queries are not fully replaced yet.
...
Constraints used for point properties or spatial queries are not fully replaced yet.
