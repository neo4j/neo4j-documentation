...
----
a|
New Cypher command for creating an alias for a database name. Remote aliases are only supported from version 4.4.6.
...
----
a|
New Cypher command for altering an alias. Remote aliases are only supported from version 4.4.6.
...
----
a|
New Cypher command for listing database aliases. Only supported since version 4.4.6.
...
----
a|
New privilege that allows a user to create, modify, delete and list aliases. Only supported since version 4.4.6.
...
----
a|
New privilege that allows a user to create aliases. Only supported since version 4.4.6.
...
----
a|
New privilege that allows a user to modify aliases. Only supported since version 4.4.6.
...
----
a|
New privilege that allows a user to delete aliases. Only supported since version 4.4.6.
...
----
a|
New privilege that allows a user to show aliases. Only supported since version 4.4.6.
|===
