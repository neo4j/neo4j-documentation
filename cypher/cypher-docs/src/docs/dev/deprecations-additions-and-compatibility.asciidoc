...
----
a|
Privileges can be specified as `IMMUTABLE` which means that they cannot be altered by users with Privilege Management. They can only be administered when running with full access.
