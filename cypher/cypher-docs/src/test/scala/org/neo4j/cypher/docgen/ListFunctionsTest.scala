...
class ListFunctionsTest extends DocumentingTest {
  ...
  override def doc = new DocBuilder {
    ...
    section("range()", "functions-range") {
      ...
      query(
        """RETURN range(0, 10), range(2, 18, 3), range(0, 5, -1)""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("toBooleanList()", "functions-tobooleanlist") {
      ...
      query(
        """RETURN toBooleanList(null) as noList,
          ...
          |toBooleanList(['a string', true, 'false', null, ['A','B']]) as mixedList""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("toFloatList()", "functions-tofloatlist") {
      ...
      query(
        """RETURN toFloatList(null) as noList,
          ...
          |toFloatList(['a string', 2.5, '3.14159', null, ['A','B']]) as mixedList""".stripMargin,
        ResultAssertions((r) => {
          r.columnAs[Iterable[_]]("noList").toList.head should equal(null)
          r.columnAs[Iterable[_]]("nullsInList").toList.head should equal(Array(null, null))
    ...
    section("toIntegerList()", "functions-tointegerlist") {
      ...
      query(
        """RETURN toIntegerList(null) as noList,
          ...
          |toIntegerList(['a string', 2, '5', null, ['A','B']]) as mixedList""".stripMargin,
        ResultAssertions((r) => {
          r.columnAs[Iterable[_]]("noList").toList.head should equal(null)
          r.columnAs[Iterable[_]]("nullsInList").toList.head should equal(Array(null, null))
    ...
    section("toStringList()", "functions-tostringlist") {
      ...
      query(
        """RETURN toStringList(null) as noList,
          ...
          |toStringList(['already a string', 2, date({year:1955, month:11, day:5}), null, ['A','B']]) as mixedList""".stripMargin,
        ResultAssertions((r) => {
          r.columnAs[Iterable[_]]("noList").toList.head should equal(null)
          r.columnAs[Iterable[_]]("nullsInList").toList.head should equal(Array(null, null))
          r.columnAs[Iterable[_]]("mixedList").toList.head should equal(Array(
            "already a string",
            "2",
            "1955-11-05",
            null,
