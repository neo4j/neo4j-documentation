  ...
  override def doc = new DocBuilder {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            Map("n.name" -> "A", "n.age" -> 34),
            Map("n.name" -> "B", "n.age" -> 36),
            Map("n.name" -> "C", "n.age" -> 32)
          ))
        })
      ) {
    ...
    section("Order nodes by multiple properties", "order-nodes-by-multiple-properties") {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            Map("n.age" -> 32, "n.name" -> "C"),
            Map("n.age" -> 34, "n.name" -> "A"),
            Map("n.age" -> 36, "n.name" -> "B")
          ))
        })
      ) {
    ...
    section("Order nodes by expression", "order-nodes-by-expression") {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            Map("n.length" -> 170, "n.name" -> "A", "n.age" -> 34),
            Map("n.length" -> 185, "n.name" -> "C", "n.age" -> 32),
            Map("n.length" -> null, "n.name" -> "B", "n.age" -> 36)
          ))
        })
      ) {
    ...
    section("Ordering `null`", "order-null") {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            Map("n.age" -> 34, "n.name" -> "A", "n.length" -> 170),
            Map("n.age" -> 32, "n.name" -> "C", "n.length" -> 185),
            Map("n.age" -> 36, "n.name" -> "B", "n.length" -> null)
          ))
        })
      ) {
