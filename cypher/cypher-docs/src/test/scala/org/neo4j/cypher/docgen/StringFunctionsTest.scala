...
class StringFunctionsTest extends DocumentingTest {
  ...
  override def doc = new DocBuilder {
    ...
    section("left()", "functions-left") {
      ...
      query(
        """RETURN left('hello', 3)""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("ltrim()", "functions-ltrim") {
      ...
      query(
        """RETURN lTrim('   hello')""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("replace()", "functions-replace") {
      ...
      query(
        """RETURN replace("hello", "l", "w")""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("reverse()", "functions-reverse") {
      ...
      query(
        """RETURN reverse('anagram')""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("right()", "functions-right") {
      ...
      query(
        """RETURN right('hello', 3)""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("rtrim()", "functions-rtrim") {
      ...
      query(
        """RETURN rTrim('hello   ')""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("split()", "functions-split") {
      ...
      query(
        """RETURN split('one,two', ',')""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("substring()", "functions-substring") {
      ...
      query(
        """RETURN substring('hello', 1, 3), substring('hello', 2)""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("toLower()", "functions-tolower") {
      ...
      query(
        """RETURN toLower('HELLO')""".stripMargin,
        ResultAssertions((r) => {
    ...
    section("toStringOrNull()", "functions-tostringornull") {
      ...
      query(
        """RETURN toStringOrNull(11.5),
          ...
          #toStringOrNull(['A', 'B', 'C']) AS list""".stripMargin('#'),
        ResultAssertions((r) => {
          r.toList should equal(List(Map(
    ...
    section("toUpper()", "functions-toupper") {
      ...
      query(
        """RETURN toUpper('hello')""".stripMargin,
        ResultAssertions((r) => {
