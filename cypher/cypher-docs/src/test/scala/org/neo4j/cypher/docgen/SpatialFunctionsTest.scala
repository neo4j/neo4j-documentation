...
class SpatialFunctionsTest extends DocumentingTest {
  ...
  override def doc = new DocBuilder {
    ...
    section("point() - WGS 84 2D", "functions-point-wgs84-2d") {
      p("`point(longitude|x, latitude|y)` returns a 2D point in the _WGS 84_ CRS category corresponding to the given coordinate values.")
      function("point({longitude | x, latitude | y [, crs]})", "A 2D point in _WGS 84_.", ("A single map consisting of the following:", ""), ("longitude/x", "A numeric expression that represents the longitude/x value in decimal degrees"), ("latitude/y", "A numeric expression that represents the latitude/y value in decimal degrees"), ("crs", "'WGS-84'"))
    ...
    section("point() - WGS 84 3D", "functions-point-wgs84-3d") {
      p("`point(longitude|x, latitude|y, height|z)` returns a 3D point in the _WGS 84_ CRS category corresponding to the given coordinate values.")
      function("point({longitude | x, latitude | y, height | z, [, crs]})", "A 3D point in _WGS 84_.", ("A single map consisting of the following:", ""), ("longitude/x", "A numeric expression that represents the longitude/x value in decimal degrees"), ("latitude/y", "A numeric expression that represents the latitude/y value in decimal degrees"), ("height/z", "A numeric expression that represents the height/z value in meters"), ("crs", "'WGS-84-3D'"))
    ...
    section("point() - Cartesian 2D", "functions-point-cartesian-2d") {
      p("`point(x, y)` returns a 2D point in the _Cartesian_ CRS category corresponding to the given coordinate values.")
      function("point({x, y [, crs]})", "A 2D point in _Cartesian_.", ("A single map consisting of the following:", ""), ("x", "A numeric expression"), ("y", "A numeric expression"), ("crs", "'cartesian'"))
      considerations("If any argument provided to `point()` is `null`, `null` will be returned.")
    ...
    section("point() - Cartesian 3D", "functions-point-cartesian-3d") {
      p("`point(x, y, z)` returns a 3D point in the _Cartesian_ CRS category corresponding to the given coordinate values.")
      function("point({x, y, z, [, crs]})", "A 3D point in _Cartesian_.", ("A single map consisting of the following:", ""), ("x", "A numeric expression"), ("y", "A numeric expression"), ("z", "A numeric expression"), ("crs", "'cartesian-3D'"))
