  ...
  override def doc = new DocBuilder {
    ...
    section("Distinguishing between when to use the simple and generic `CASE` forms", "syntax-distinguish-case") {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            Map("age_10_years_ago" -> 28, "n.name" -> "Alice"),
            Map("age_10_years_ago" -> 15, "n.name" -> "Bob"),
            Map("age_10_years_ago" -> 43, "n.name" -> "Charlie"),
            Map("age_10_years_ago" -> null, "n.name" -> "Daniel"),
            Map("age_10_years_ago" -> 31, "n.name" -> "Eskil")
          ))
        })
      ) {
      ...
      query(
        ...
        ResultAssertions((r) => {
          r.toList should equal(List(
            ...
            Map("age_10_years_ago" -> 15, "n.name" -> "Bob"),
            Map("age_10_years_ago" -> 43, "n.name" -> "Charlie"),
            Map("age_10_years_ago" -> -1, "n.name" -> "Daniel"),
            Map("age_10_years_ago" -> 31, "n.name" -> "Eskil")
          ))
        })
      ) {
