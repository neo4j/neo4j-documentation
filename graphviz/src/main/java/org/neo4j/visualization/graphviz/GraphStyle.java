...
public class GraphStyle {
    ...
    /**
     * Constructor for subclasses. Used to provide graph styles with more elaborate configuration than the default configuration parameters can provide.
     *
     * @param nodeStyle the node style to use.
     * @param edgeStyle the relationship style to use.
     */
    ...
    /**
     * Emit the end of a graph. Override this method to change the format of the end of a graph.
     *
     * @param stream the stream to emit the graph ending to.
     * @throws IOException if there is an error in emitting the graph ending.
     */
    ...
    /**
     * Emit the start of a graph. Override this method to change the format of the start of a graph.
     *
     * @param stream the stream to emit the graph start to.
     * @throws IOException if there is an error in emitting the graph start.
     */
