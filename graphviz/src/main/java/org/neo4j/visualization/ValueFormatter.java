...
/**
 * A formatter that, directed by a {@link PropertyType} can turn a value into a specific result type.
 *
 * @param <T> The result type that this formatter yields.
 */
public interface ValueFormatter<T> {
     ...
     *
     * @param type  an object representing the type of the primitive.
     * @param value the boxed primitive object to format.
     ...
     *
     * @param elementType an object representing the type of the elements of the array.
