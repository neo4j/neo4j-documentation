...
public class AsciidocHelper {
    /**
     * Cut to max 123 chars for PDF layout compliance. Or even less, for readability.
     */
    ...
    /**
     * Create graphviz output using a {@link GraphStyle}. {@link GraphStyle} is implemented by {@link AsciiDocSimpleStyle} and {@link AsciiDocStyle}.
